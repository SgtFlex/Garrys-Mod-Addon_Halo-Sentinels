...
--Base
ENT.models = {
	BaseModel = "models/sentinels/h2enforcer.mdl",
	CorpseModel = "models/sentinels/h2enforcer.mdl",
	ShieldModel = "models/sentinels/h2enforcer.mdl",
}
...
ENT.lights = {
	MainEyeLight = {Object = "", Attachment = "root", Color = "255 125 100", Scale = 3, Offset = Vector(90, 0, 32)},
	...
	Eye1_l = {Object = "", Attachment = "left_eye", Color = "0 180 255", Scale = .25, Offset = Vector(0, 0, 0)},
	Eye2_l = {Object = "", Attachment = "left_eye", Color = "0 180 255", Scale = .25, Offset = Vector(-5, -1, 12)},
	Eye3_l = {Object = "", Attachment = "left_eye", Color = "0 180 255", Scale = .25, Offset = Vector(-10, 5, 17)},
	Eye1_r = {Object = "", Attachment = "right_eye", Color = "0 180 255", Scale = .25, Offset = Vector(0, 0, 0)},
	Eye2_r = {Object = "", Attachment = "right_eye", Color = "0 180 255", Scale = .25, Offset = Vector(-5, 1, 12)},
	Eye3_r = {Object = "", Attachment = "right_eye", Color = "0 180 255", Scale = .25, Offset = Vector(-10, -5, 17)},
...
function ENT:CustomRangeAttackCode()
	...
	if (self.attackSequence == 0) then
		...
		if (self.altRocket == false) then
			self.altRocket = true
			if (self.limbs["left_rocket"]["Removed"]==false) then
			...
			self.altRocket = false
			if (self.limbs["right_rocket"]["Removed"]==false) then
				rocket:SetPos(self:GetAttachment(self:LookupAttachment("root"))["Pos"] + (Vector(0,0,50) ) + self:GetRight()*25 + self:GetForward()*-100)
				rocketCanSpawn=true
			else
				rocketCanSpawn=false
