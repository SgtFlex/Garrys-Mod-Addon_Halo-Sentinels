...
ENT.RadiusDamage = 20 * GetConVarNumber("vj_sent_sentinelDamageModifier")-- How much damage should it deal? Remember this is a radius damage, therefore it will do less damage the farther away the entity is from its enemy
...
ENT.SoundTbl_OnCollide = {"rocket_expl/rocket_expl1.wav", "rocket_expl/rocket_expl2.wav","rocket_expl/rocket_expl3.wav","rocket_expl/rocket_expl4.wav","rocket_expl/rocket_expl5.wav","rocket_expl/rocket_expl6.wav",}
